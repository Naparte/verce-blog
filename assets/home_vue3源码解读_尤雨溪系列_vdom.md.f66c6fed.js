import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.ef8e9df1.js";const u=JSON.parse('{"title":"vdom 解读","description":"","frontmatter":{},"headers":[],"relativePath":"home/vue3源码解读/尤雨溪系列/vdom.md","filePath":"home/vue3源码解读/尤雨溪系列/vdom.md","lastUpdated":1700215080000}'),p={name:"home/vue3源码解读/尤雨溪系列/vdom.md"},o=l(`<h1 id="vdom-解读" tabindex="-1">vdom 解读 <a class="header-anchor" href="#vdom-解读" aria-label="Permalink to &quot;vdom 解读&quot;">​</a></h1><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// vue2的写法</span></span>
...
<span class="line"><span style="color:#24292E;">    });</span></span>
<span class="line"><span style="color:#24292E;">  },</span></span>
<span class="line"><span style="color:#24292E;">};</span></span></code></pre></div><blockquote><p>vue3 和 vue2 带来的优化</p></blockquote><ul><li>以 on 开头在编译过程中默认绑定为监听事件（vue 认为这是最好的的处理方式，不用关注是应该绑定在 attribute 还是其他）</li><li>vue2 和 vue3 的差异，在渲染函数式可以全局导入，</li><li>h 不需要在 render 上传入；解决 vue2 大的 render 函数拆分问题；vue3 可以随意拆分块</li><li>props 扁平化传入; vue 判断 属性是否在原生 DOM 属性上，存在的话设置为 property，不存在的话设置为 attribute</li><li>vue dom 的灵感来源 snabbdom</li></ul><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">&lt;!-- 最小的vdom结构 --&gt;</span></span>
...
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">script</span><span style="color:#24292E;">&gt;</span></span></code></pre></div><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#6A737D;">&lt;!-- patch算法 --&gt;</span></span>
<span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">style</span><span style="color:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="color:#E1E4E8;">  </span><span style="color:#B392F0;">.red</span><span style="color:#E1E4E8;"> {</span></span>
<span class="line"><span style="color:#E1E4E8;">    </span><span style="color:#79B8FF;">color</span><span style="color:#E1E4E8;">: </span><span style="color:#79B8FF;">red</span><span style="color:#E1E4E8;">;</span></span>
<span class="line"><span style="color:#E1E4E8;">  }</span></span>
...
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">script</span><span style="color:#24292E;">&gt;</span></span></code></pre></div>`,6),e=[o];function c(t,E,r,y,i,F){return n(),a("div",null,e)}const h=s(p,[["render",c]]);export{u as __pageData,h as default};
