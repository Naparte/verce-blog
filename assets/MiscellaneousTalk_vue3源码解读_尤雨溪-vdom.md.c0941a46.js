import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.84f90f1e.js";const u=JSON.parse('{"title":"vdom 解读","description":"","frontmatter":{},"headers":[],"relativePath":"MiscellaneousTalk/vue3源码解读/尤雨溪-vdom.md","filePath":"MiscellaneousTalk/vue3源码解读/尤雨溪-vdom.md"}'),p={name:"MiscellaneousTalk/vue3源码解读/尤雨溪-vdom.md"},o=l(`<h1 id="vdom-解读" tabindex="-1">vdom 解读 <a class="header-anchor" href="#vdom-解读" aria-label="Permalink to &quot;vdom 解读&quot;">​</a></h1><h2 id="写法差异" tabindex="-1">写法差异 <a class="header-anchor" href="#写法差异" aria-label="Permalink to &quot;写法差异&quot;">​</a></h2><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// vue2的写法</span></span>
